...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void getOrderLocation(){
        ...
        Call<Weather> call = apiInterface.getWeatherByCity(lat,lon);
        call.enqueue(new Callback<Weather>() {
            ...
            public void onResponse(Call<Weather> call, Response<Weather> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    Double lng = response.body().getCoord().getLon();

                    MarkerOptions markerOptions = new MarkerOptions();
                    LatLng orderlatLng = new LatLng(lat, lng);
                    // Position of Marker on Map
                    markerOptions.position(orderlatLng);
                    ...
                    Polyline path = mMap.addPolyline(new PolylineOptions()
                            .add(
                                    new LatLng(-1.03326,37.06933 )
                                    //new LatLng(	-0.90258400,37.18748350)
                            )
                    );
                    // Style the polyline
                    path.setWidth(10);
                    ...
                    mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(orderlatLng, 16));
                    // mMap.moveCamera(CameraUpdateFactory.newLatLng(orderlatLng));
                    // mMap.animateCamera(CameraUpdateFactory.zoomTo(11));
                    //getRoute(orderlatLng);
